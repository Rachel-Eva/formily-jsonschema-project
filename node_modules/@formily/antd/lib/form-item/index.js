...
var isTooltipProps = function (tooltip) {
    return !(0, react_is_1.isElement)(tooltip);
};
...
var ICON_MAP = {
    ...
    warning: react_1.default.createElement(icons_1.ExclamationCircleOutlined, null),
};
var BaseItem = function (_a) {
    var _b, _c, _d, _e, _f;
    var children = _a.children, props = __rest(_a, ["children"]);
    var _g = __read((0, react_1.useState)(false), 2), active = _g[0], setActive = _g[1];
    ...
    var label = formLayout.label, style = formLayout.style, layout = formLayout.layout, _j = formLayout.colon, colon = _j === void 0 ? true : _j, addonBefore = formLayout.addonBefore, addonAfter = formLayout.addonAfter, asterisk = formLayout.asterisk, _k = formLayout.requiredMark, requiredMark = _k === void 0 ? true : _k, _l = formLayout.optionalMarkHidden, optionalMarkHidden = _l === void 0 ? false : _l, feedbackStatus = formLayout.feedbackStatus, extra = formLayout.extra, feedbackText = formLayout.feedbackText, fullness = formLayout.fullness, feedbackLayout = formLayout.feedbackLayout, feedbackIcon = formLayout.feedbackIcon, _m = formLayout.enableOutlineFeedback, enableOutlineFeedback = _m === void 0 ? true : _m, getPopupContainer = formLayout.getPopupContainer, inset = formLayout.inset, _o = formLayout.bordered, bordered = _o === void 0 ? true : _o, labelWidth = formLayout.labelWidth, wrapperWidth = formLayout.wrapperWidth, labelCol = formLayout.labelCol, wrapperCol = formLayout.wrapperCol, labelAlign = formLayout.labelAlign, _p = formLayout.wrapperAlign, wrapperAlign = _p === void 0 ? 'left' : _p, size = formLayout.size, labelWrap = formLayout.labelWrap, wrapperWrap = formLayout.wrapperWrap, tooltipLayout = formLayout.tooltipLayout, tooltip = formLayout.tooltip, tooltipIcon = formLayout.tooltipIcon;
    ...
    var formatChildren = feedbackLayout === 'popover' ? (react_1.default.createElement(antd_1.Popover, { autoAdjustOverflow: true, placement: "top", content: react_1.default.createElement("div", { className: (0, classnames_1.default)((_b = {},
    ...
    var gridStyles = {};
    var tooltipNode = isTooltipProps(tooltip) ? (react_1.default.createElement(antd_1.Tooltip, __assign({}, tooltip))) : (tooltip);
    var getOverflowTooltip = function () {
        if (overflow) {
            return (react_1.default.createElement("div", null,
                react_1.default.createElement("div", null, label),
                react_1.default.createElement("div", null, tooltipNode)));
        }
        return tooltipNode;
    };
    var renderLabelText = function () {
        var _a;
        var labelChildren = (react_1.default.createElement("div", { className: "".concat(prefixCls, "-label-content"), ref: containerRef },
            react_1.default.createElement("span", { ref: contentRef },
                asterisk && requiredMark === true && (react_1.default.createElement("span", { className: "".concat(prefixCls, "-asterisk") }, '*')),
                react_1.default.createElement("label", { htmlFor: props.labelFor }, label),
                !asterisk && requiredMark === 'optional' && !optionalMarkHidden && (react_1.default.createElement("span", { className: "".concat(prefixCls, "-optional") }, (_a = locale === null || locale === void 0 ? void 0 : locale.Form) === null || _a === void 0 ? void 0 : _a.optional)))));
        if ((tooltipLayout === 'text' && tooltip) || overflow) {
            return (react_1.default.createElement(antd_1.Tooltip, { placement: "top", align: { offset: [0, 10] }, title: getOverflowTooltip() }, labelChildren));
        }
        return labelChildren;
    };
    var renderTooltipIcon = function () {
        if (tooltip && tooltipLayout === 'icon' && !overflow) {
            return (react_1.default.createElement("span", { className: "".concat(prefixCls, "-label-tooltip-icon") },
                react_1.default.createElement(antd_1.Tooltip, { placement: "top", align: { offset: [0, 2] }, title: tooltipNode }, tooltipIcon)));
        }
    };
    var renderLabel = function () {
        ...
        return (react_1.default.createElement("div", { className: (0, classnames_1.default)((_a = {},
            ...
            renderLabelText(),
            renderTooltipIcon(),
            label !== ' ' && (react_1.default.createElement("span", { className: "".concat(prefixCls, "-colon") }, colon ? ':' : ''))));
    };
    return (react_1.default.createElement("div", __assign({}, (0, __builtins__1.pickDataProps)(props), { style: __assign(__assign({}, style), gridStyles), "data-grid-span": props.gridSpan, className: (0, classnames_1.default)((_c = {},
            _c["".concat(prefixCls)] = true,
            _c["".concat(prefixCls, "-layout-").concat(layout)] = true,
            _c["".concat(prefixCls, "-").concat(feedbackStatus)] = enableOutlineFeedback && !!feedbackStatus,
        ...
        react_1.default.createElement("div", { className: (0, classnames_1.default)((_d = {},
            ...
            react_1.default.createElement("div", { className: (0, classnames_1.default)("".concat(prefixCls, "-control-content")) },
                ...
                react_1.default.createElement("div", { style: wrapperStyle, className: (0, classnames_1.default)((_e = {},
                        ...
                        _e)) },
                    react_1.default.createElement(form_layout_1.FormLayoutShallowContext.Provider, { value: undefined }, formatChildren),
